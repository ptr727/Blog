...
To get all the data from Server-1 to fit on Server-2, I pruned the near 60TB set down to around 40TB. You know how it works, no matter how much storage you have it will always be filled. I purchased 4 x [12TB Seagate IronWolf ST12000VN0007](https://amzn.to/2Wr6WIm) drives, and combined with 2 x 4TB HGST drives, gave me around 44TB of usable storage space, enough to copy all the important data from Server-1 to Server-2.
