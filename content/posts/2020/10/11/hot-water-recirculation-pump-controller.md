...
- Solder four [Dallas 18B20](https://amzn.to/3iw5wGT) waterproof temperature probes to the 2.5mm [TRRS connector](https://amzn.to/3jzyoPY), and insulate and protect using [heat shrink tubing](https://amzn.to/2HTOHJf). Verify your specific TRRS cable wiring colors.
...
- While still using the FTDI programmer for power, verify the TH10 connects over WiFi and is operational in ESPHome and Home Assistant.
