---
title: Koubachi Wi-Fi Plant Sensor
date: '2012-09-08T00:54:48+00:00'
url: /2012/09/07/koubachi-wi-fi-plant-sensor/
categories:
- review
tags:
- koubachi
...
post_id: '320'
---
Last week several tech and gadget news outlets reported that the [Koubachi Wi-Fi Plant Sensor](http://www.koubachi.com/) has been released and is available for order ([Amazon](http://amzn.to/U10uAf) or [SmartHome](http://www.smarthome.com/69520/Koubachi-K001-Wi-Fi-Plant-Sensor/p.aspx)). I remembered reading about this device some time ago, and I decided to try it out.

Our houseplants are under my care, and they are generally happy and healthy. A simple water moisture indicator would not get my attention, and certainly would not be worthy of a place in my collection of semi-useful/useless Wi-Fi enabled devices (of which the [Nest Learning Thermostat](http://amzn.to/UyIRcY) is the most useful), but the Koubachi promises more than just moisture monitoring:
...
[![Koubachi.Box](/media/2012/09/koubachi-box_thumb.jpg)](/media/2012/09/koubachi-box_.jpg)[![Koubachi.Battery](/media/2012/09/koubachi-battery_thumb.jpg)](/media/2012/09/koubachi-battery.jpg)

The installation and configuration process is interesting. There is only one button on the device, no USB plugs for direct configuration. In order to configure the device to connect to your Wi-Fi network, you first place it in [Ad-Hoc](http://en.wikipedia.org/wiki/Wireless_ad-hoc_network) mode, then directly connect to it using your computer Wi-Fi adapter, then access the device settings using a web browser, and configure the Wi-Fi settings, after which the device will connect to your home network.
