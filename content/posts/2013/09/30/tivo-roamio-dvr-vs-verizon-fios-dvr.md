---
title: TiVo Roamio DVR vs. Verizon FiOS DVR
date: '2013-09-30T22:00:50+00:00'
url: /2013/09/30/tivo-roamio-dvr-vs-verizon-fios-dvr/
categories:
- review
tags:
- dvr
...
post_id: '452'
---
I just replaced the last of my four [Verizon FiOS DVR](http://www.verizon.com/home/fiostv/equipment/) boxes with a [TiVo Roamio DVR](https://www.tivo.com/shop/roamio) box.

The last time I used a TiVo was about seven years ago, it was a [DirecTV TiVo](http://www.directv.com/technology/tivo_receiver) box, commonly referred to as a DirecTiVo. At that time DirectTV was my only option for television service, TiVo the only option for a DVR, and AT&T DSL the only option for internet and phone.
...
I've often considered switching to non-Verizon DVR solutions, like the [Moxi](http://www.moxi.com/) or the [Ceton Q](http://cetoncorp.com/blog/its-been-a-busy-6-months/). I tried a Window MCE box with a [Ceton infiniTV6 ETH](http://cetoncorp.com/products/infinitv-6-ethernet/) CableCard decoder, worked ok, but the form factor was not very practical, and it required constant maintenance. The Moxi is no longer available for purchase, and the Ceton Q appears to be vaporware. The [TiVo Premiere](https://www.tivo.com/shop/detail/tivo-premiere) was an option, but I found the cost prohibitive, and it did not offer substantially more than my Verizon FiOS DVR box.

TiVo recently released the new Roamio range of DVR's. They offer three variants, the Roamio, Romio Plus, and Roamio Pro, differences and details are [here](https://www.tivo.com/shop/roamio#tab1). These new devices offer 4 to 6 tuners, 75 to 450 hours of HD recording capacity, and pricing ranges from $200 to $600. You still have to pay TiVo $15 per month or a $500 lifetime TiVo service fee per device, as well as the $5 Verizon per-cablecard fee, a total of $20 per month. Compared to $20 per month for a Verizon multi-room HD DVR offering 50 hours of HD recording and 2 tuners, TiVo is equally priced on a month-to-month basis, costs more upfront, but offers significantly more capability and capacity. [Amazon](http://www.amazon.com/gp/product/B00E8HGWIK/ref=as_li_ss_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=B00E8HGWIK&linkCode=as2&tag=pievilsblo-20) occasionally offers the Roamio units cheaper than TiVo direct, and [weaKnees](http://www.weaknees.com/tivo-roamio-series5.php) offers units with upgraded capacity.

The [TiVo Mini](https://www.tivo.com/shop/mini) is a playback only device that lets you watch live or recorded TV. You need to pair it with a Roamio, and it acts like an extender for the Roamio UI. What makes no sense is that you need to buy it at $100, and then still pay a monthly $6 or lifetime $150 service fee. I am already paying a subscription fee for the main Roamio, why do I need to pay twice?
...
[![Roamio Size Front](/media/2013/09/roamio-size-1.jpg?w=300)](/media/2013/09/roamio-size-1.jpg)[![Roamio Size Back](/media/2013/09/roamio-size-2.jpg?w=300)](/media/2013/09/roamio-size-2.jpg)
...
[![Roamio Remotes](/media/2013/09/roamio-remotes.jpg?w=300)](/media/2013/09/roamio-remotes.jpg)

The Roamio remote is smaller than the Mini remote, and supports both IR and RF, making it work through cabinet doors. The standard Verizon remote is ugly and bulky. I use [URC MX-890](http://www.universalremote.com/product_details.php?id=10&s=residential&c=user_interfaces&p=MX-890) programmable IR/RF remotes with RF to IR base stations.
...
[![TiVo.Hour](/media/2013/09/tivo-hour.jpg?w=300)](/media/2013/09/tivo-hour.jpg)
...
I contacted TiVo support, who told me the problem is my internet connection, and that network switches are not supported, and that I need to connect the TiVo directly to my router, what? My house is wired with CAT6 connected to a HP ProCurve gigabit switch, and each AV closet has a TrendNET TEG-S8g 8-port gigabit switch. Nothing wrong with my network, and nothing wrong with my internet access, the TiVo is the only device with issues. No point arguing with support, they suggested I disconnect ethernet and instead use the built-in [MoCA](http://www.mocalliance.org/) bridge for internet connectivity. This worked, no more connectivity issues.

After some more research I found similar issues reported on the [TiVo Community](http://www.tivocommunity.com/) forum, siting incompatibility with "green" or 802.11az compliant switches. TiVo [acknowledged](http://www.tivocommunity.com/tivo-vb/showthread.php?p=9817637#post9817637) the problem, and [stated](http://www.tivocommunity.com/tivo-vb/showthread.php?p=9830828#post9830828) a future update would resolve the issue.
